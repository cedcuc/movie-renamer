...
public abstract class FanartTvScrapper<M extends Media> extends ImageScrapper<M> {
  ...
  protected final String host = "webservice.fanart.tv/v3";
  ...
  protected FanartTvScrapper() {
    ...
    String key = "ee5c3791a8f6b58d8a384678ec1a1c42";
  ...
  protected final List<ImageInfo> fetchImagesInfo(M media) throws Exception {
    ...
    //http://webservice.fanart.tv/v3/movies/tt0371552?api_key=ee5c3791a8f6b58d8a384678ec1a1c42
    URL searchUrl = new URL("http", host, "/" + getTypeName() + "/" + media.getMediaId() + "/?api_key="+apikey);// Last slash is required
